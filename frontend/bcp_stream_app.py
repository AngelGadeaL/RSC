...
proyecto = st.selectbox("BCP Indique el Proyecto a trabajar", options=["YAPE", "MBBK"])
...
if st.button("Buscar"):
    if not consulta.strip():
        ...
        st.write(f"Proyecto seleccionado: {proyecto}")
        with st.spinner(f"Buscando los recursos para el Proyecto: {proyecto}..."):
            try:
